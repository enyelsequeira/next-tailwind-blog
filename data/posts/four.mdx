...
keywords:
  ...
  - Node
  - TypeScript
authorImage: /images/3.jpeg
authorProfession: Web-Developer
---
...
5. Choose what account you want this project to be associated with `const text =(test) => text`
...
![Firebase Console](/images/1.jpeg)
...
![Firebase Console](/images/2.jpeg)

Step 2

3. Download the config file and place it in the app level (in the app folder).

![Firebase Console](/images/3.jpeg)

4. In the project level build.gradle, add the following:

![Firebase Console](/images/4.jpeg)

5. In the app level build.gradle add the following:

![Firebase Console](/images/1.jepg)

6. Lastly, in the app level build.gradle file (same file as above), 

7. find the applicationId and change it to the name you chose in step 2.  In my case I used com.benjamincarlson.medium_tutorial.
